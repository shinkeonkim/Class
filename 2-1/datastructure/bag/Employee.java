...
public abstract class Employee 
{
   ...
   private Date Covid19ConfirmedDate = new Date(1990,1,1);
      ...
      int month, int day, int year )
   {
      ...
      Covid19 = false;
      Covid19ConfirmedDate = new Date(5,10,1990);
   } // end six-argument Employee constructor

   public void setCovid19(Boolean isconfirmed) {
      Covid19 = isconfirmed;
   }
   ...
   public void setCovid19ConfirmedDate(Date confimedDate) {
      Covid19ConfirmedDate = confimedDate;
   }

   public Date getCovid19ConfirmedDate() {
      return Covid19ConfirmedDate;
   }
